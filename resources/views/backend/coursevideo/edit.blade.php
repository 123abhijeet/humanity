		...
		<div class="page-header">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<h5 class="text-uppercase mb-0 mt-0 page-title">Edit Course Video</h5>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<ul class="breadcrumb float-right p-0 mb-0">
						...
						<li class="breadcrumb-item"><span> Edit Course Video</span></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="page-content">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card">
						<div class="card-body">
							<form method="post" action="{{route('coursevideos.update',$coursevideo->id)}}">
								@csrf
								@method('put')
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-12">
										<div class="form-group">
											...
											<select class="form-control @error('course_category') is-invalid @enderror" name="course_category" id="course_category">
												...
												<option value="{{$item->id}}" @if($coursevideo->course_category == $item->id) selected @endif>{{$item->category_name}}</option>
												@endforeach
											</select>
										...
										<div class="form-group">
											...
											<input type="text" name="total_videos" class="form-control" id="total_video" value="{{$coursevideo->total_videos}}" readonly>
											@error('total_videos')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="form-group">
											...
											<input type="text" name="section" class="form-control" value="{{$coursevideo->section}}">
											@error('section')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="table-responsive">
											<table class="table custom-table datatable">
												...
												<tbody>
													@foreach($course_video_item as $key=>$item)
													<tr>
														<td>{{++$key}}</td>
														<td>{{$item->title}}</td>
														<td>{{$item->duration}}</td>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		var selectedSubCategory = "{{ $coursevideo->course_subcategory }}";
		var selectedCourse = "{{ $coursevideo->course }}";
