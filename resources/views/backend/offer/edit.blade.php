        ...
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <h5 class="text-uppercase mb-0 mt-0 page-title">Edit Offer</h5>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <ul class="breadcrumb float-right p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><span> Edit Offer</span></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    <form method="post" action="{{route('offers.update',$offer->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('offer_title') is-invalid @enderror" name="offer_title" value="{{$offer->offer_title}}" />
                                            @error('offer_title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" value="{{$offer->start_date}}" />
                                            @error('start_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('offer_value') is-invalid @enderror" name="offer_value" value="{{$offer->offer_value}}" />
                                        @error('offer_value')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" value="{{$offer->end_date}}" />
                                        @error('end_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
