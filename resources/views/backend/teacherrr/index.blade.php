...
@section('title','Teacher Review Rating | Sattree Gurukul')
@section('body')
<style>
...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="page-title mb-0">Teacher Review Rating</h3>
                </div>
                <div class="col-md-6">
                    <ul class="breadcrumb mb-0 p-0 float-right">
                        ...
                        <li class="breadcrumb-item"><span>Teacher Review Rating</span></li>
                    </ul>
                </div>
            </div>
        </div>
